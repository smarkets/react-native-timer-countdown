...
class TimerCountdown extends React.Component {
    constructor() {
        ...
        this.tick = () => {
            ...
            const previousSeconds = this.state.previousSeconds;
            const dt = previousSeconds ? currentSeconds - previousSeconds : 0;
            const interval = 1000;
    ...
    render() {
        ...
        const allowFontScaling = this.props.allowFontScaling || false;
